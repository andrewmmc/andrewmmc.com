...
author: Andrew Mok
description: Serve your retina images in Vue as well
---
...
> **UPDATE in 2020: You may consider `srcset` and `picture/source` for native support on retina images. **[**Please refer to this doc for example.**](https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images)
